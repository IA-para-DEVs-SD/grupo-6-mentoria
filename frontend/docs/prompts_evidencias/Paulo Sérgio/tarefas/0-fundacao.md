[← Voltar à sessão](../2026-03-22/01-scaffold-fundacao.md)

---

## 🤖 Assertividade com IA

Tarefa executada integralmente pela IA em um único prompt. O desenvolvedor forneceu a especificação completa em Markdown e a IA criou 56 arquivos de uma vez — scaffold, configurações, types, services, stores, router e páginas placeholder.

**Pontos fortes:**

- Especificação detalhada em .md permitiu execução sem ambiguidade
- A IA seguiu a estrutura de pastas e convenções de nomenclatura definidas
- Build de validação (`npm run build`) executado automaticamente ao final
- Zero retrabalho — tudo funcionou na primeira execução

[Ver prompt utilizado](../2026-03-22/01-scaffold-fundacao.md)
