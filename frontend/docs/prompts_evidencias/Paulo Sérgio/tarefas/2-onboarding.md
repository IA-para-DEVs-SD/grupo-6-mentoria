[← Voltar à sessão](../2026-03-22/02-features-core.md)

---

## 🤖 Assertividade com IA

Feature mais complexa do frontend — 5 steps com Stepper PrimeVue. A IA encontrou e corrigiu erros de tipagem TypeScript sozinha durante o build de validação.

**Pontos fortes:**

- IA consultou o MVP como referência visual antes de implementar
- Detectou e corrigiu incompatibilidades de tipo automaticamente (DatePicker esperava `Date`, não `string`)
- Criou composable `useOnboarding` para gerenciar estado entre steps — boa separação de responsabilidades
- Ciclo de autocorreção: build → identificar erros → corrigir → rebuild, sem intervenção humana

[Ver prompt utilizado](../2026-03-22/02-features-core.md)
